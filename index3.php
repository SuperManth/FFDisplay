				...
				<div id="karte2">
					<script>
						...
						function initMap2() {
								...
								var map2 = new google.maps.Map(document.getElementById('karte2'), {
									zoom: 12,
						...
						function setMarkers2(map2) {
							for (var i = 0; i <  markers2.length; i++) {
								var marker2 = new google.maps.Marker({
									position: {lat: Number(markers2[i][1]), lng: Number(markers2[i][2])},
									map: map2,
									label: 'H'
								});
							};
					 ...
					 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDhg93adqrzNISVzbnw9bfhT7Uoddq7riY&callback=initMap2" async defer></script>
				</div>
			</div>
			<footer>
